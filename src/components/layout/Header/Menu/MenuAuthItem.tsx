      ...
      <div className="flex flex-col md:flex-row">
        {  auth ? (
          ...
          <>
            ...
            <Link className="block px-6 py-2 md:px-2 navlink md:bg-slate-500 md:text-white rounded-xl hover:text-black md:hover:text-white md:hover:bg-slate-600 transition-colors duration-200" to="/account/register">Sign up</Link>
          </>
        ) }
      </div>
    </li>
